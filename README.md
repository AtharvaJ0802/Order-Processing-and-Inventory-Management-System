...
Language Used Java    =  v17.
____________________________________________________________________________________
Spring-Boot Framework =  v3.2   
____________________________________________________________________________________
Gradle                =  v8. Used as Build Tool
____________________________________________________________________________________
DB Used PostgreSQL	  =  v15.
____________________________________________________________________________________
Redpanda              =  Version Kafka-compatible	& used for Latest Event streaming.
____________________________________________________________________________________
Flyway	              =  v9.   Used for DB migrations         
____________________________________________________________________________________
springdoc-openapi  	  =  v2.3	  Swagger UI            
____________________________________________________________________________________
Testcontainers	      =  v1.19  Integration tests Package
____________________________________________________________________________________
